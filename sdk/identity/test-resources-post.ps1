...
mvn clean install -DskipTests "-Drevapi.skip" "-Dcheckstyle.skip" "-Dspotbugs.skip" "-Dmaven.javadoc.skip=true" "-Dspotless.check.skip=true" -f "$azStorageRootPom/azure-storage-blob/pom.xml" | Write-Host
